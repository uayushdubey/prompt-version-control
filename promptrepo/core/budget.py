...
Usage:
    from promptrepo.core.budget import BudgetGuard, BudgetExceededError
...
class BudgetExceededError(Exception):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            f"Increase limit with: promptrepo config set budget.max_session_cost <amount>"
        )
